...
int ClaSubstration(stDate Data1, stDate Data2)
{
	int Substration = abs(claSumOfAllDay(Data1.year, Data1.month, Data1.day) - claSumOfAllDay(Data2.year , Data2.month , Data2.day));

	return Substration;
}
int main()
{
	stDate Data1 = GetAllData();
	stDate Data2 = GetSystemDate(); 
	cout << " \n your Barth Day = " << ClaSubstration(Data1, Data2)  << endl;
